      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          <div className="flex flex-col justify-center max-w-xl">
             ...
             <span className="text-2xl font-light text-[#2C2A26] mb-8">Gs. {product.price.toLocaleString('es-PY')}</span>
             ...
             <div className="flex flex-col gap-4">
               ...
               <button 
                 ...
                 className="w-full py-5 border border-[#2C2A26] text-[#2C2A26] uppercase tracking-widest text-sm font-medium hover:bg-[#EBE7DE] transition-colors flex items-center justify-center gap-3"
               >
