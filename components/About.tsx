  ...
  return (
    <section id="about" className="bg-muted">
      ...
      <div className="py-24 px-6 md:px-12 max-w-[1800px] mx-auto flex flex-col md:flex-row items-start gap-16 md:gap-32">
        ...
        <div className="md:w-2/3 max-w-2xl">
          ...
          <img 
            ...
            className="w-full h-[400px] object-cover mt-12 shadow-xl rounded-2xl"
          />
          <p className="text-sm font-medium uppercase tracking-widest text-muted-foreground mt-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        ...
        <div className="order-1 lg:order-2 flex flex-col justify-center p-12 lg:p-24 bg-primary/10">
           <span className="text-xs font-bold uppercase tracking-[0.2em] text-primary mb-6">Calidad</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[80vh]">
        <div className="flex flex-col justify-center p-12 lg:p-24 bg-secondary text-secondary-foreground">
           <span className="text-xs font-bold uppercase tracking-[0.2em] opacity-80 mb-6 text-white">Atención</span>
